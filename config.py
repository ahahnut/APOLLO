...
word_emb_path = '/mnt/bst/hxu10/hxu10/data/glove.840B.300d.txt'
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--epsilon_noise', type=float, default=4.0)

    #Correlation Remove Degree
    parser.add_argument('--correlation_v', type=float, default=1.0)
    parser.add_argument('--correlation_a', type=float, default=1.0)
    parser.add_argument('--correlation_t', type=float, default=1.0)
